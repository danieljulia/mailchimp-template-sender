...
you can get lots of them from mailchimp site or others
The idea is to write the contents from WP using WP custom loops,ç
like this example
*/

//filter the content for category General
$args=array('category_name' => 'General');
$the_query = new WP_Query( $args ); 
//the query is used below in the template

/*
See below the dynamic wp content
You need to create the content in the template as a regular wp template
*/
?>
